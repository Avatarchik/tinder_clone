...
- (void)setBackgroundImage:(UIImage *)backgroundImage {
    if (backgroundImage) {
        _bannerImageView.image = [backgroundImage applyLightEffect];
        _bannerImageView.contentMode = UIViewContentModeScaleAspectFit;
        _bannerImageViewWithImageEffects.image = backgroundImage;
    }
}
...
// avatar
- (void)setAvatarImage:(UIView *)avatarImage {
    if (avatarImage) {
        // [_avatarButton setImage:avatarImage forState:UIControlStateNormal];
        [_avatarButton addSubview:avatarImage];
    }
}
...
- (void)_setup {
    ...
    _avatarButton = [[UIButton alloc] initWithFrame:CGRectMake(self.center.x-avatarButtonHeight/2, -30, avatarButtonHeight, avatarButtonHeight)];
    
    _userNameLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 35, self.frame.size.width, 34)];
    ...
    _birthdayLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 60, self.frame.size.width, 24)];
